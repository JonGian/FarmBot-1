...
class Farmbot_api:
                ...
                col_values.append(
                    {
                        ...
                        "plant_date": points["created_at"],
                        "openfarm_slug": points["openfarm_slug"],
                    }
                )
    ...
    def get_plant_groups(self, user_email, database: Database, headers):
        ...
        for group in data:
            ...
            if ("pointer_type" in group["criteria"]["string_eq"]) and group["criteria"][
                "string_eq"
            ]["pointer_type"][
                0
            ] == "Plant":  # plant group
                plants = []
                if (
                    "openfarm_slug" in group["criteria"]["string_eq"]
                ):  # plants in the group
